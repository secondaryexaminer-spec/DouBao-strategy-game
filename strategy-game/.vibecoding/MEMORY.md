...
- 单位类型（33 种）：陆军 10（民兵/侦察/长枪/剑士/弓箭/弩手/工程师/骑兵/近卫/投石车）+ 海军 5（桨帆船/战船/战舰/驳船/运兵船）+ 神罗专属 6（重甲步兵/长矛方阵/帝国弩手/帝国近卫军/攻城塔/重型投石车）+ 神罗国家特色 3（奥地利骑士/普鲁士掷弹兵/巴伐利亚山地弩手）+ 金帐专属 6（轻骑兵/汗国骑兵/骑射手/游牧弓手/快速桨帆船/游牧战车）+ 金帐国家特色 3（可汗亲卫/骆驼骑兵/游牧重炮）。远程 4：投石车、战舰。
- **阵营系统（阶段1完成）**：5 阵营（神圣罗马帝国/金帐汗国/威尼斯共和国/马穆鲁克苏丹国/大明帝国），15 国家（每阵营 3 国）。constants.js 有 FACTIONS/NATIONS 定义；开始界面有阵营/国家两级下拉框（阵营切换联动国家列表）；game.settings 含 faction/nation；开局日志显示阵营/国家/特色兵种。目前仅玩家可选阵营，AI 暂用通用兵种。TYPES 兵种已新增 faction 字段（hre 与 goldenHorde 各 9 种标记，未做可用性过滤，全阵营可造；text 中的特殊能力为描述性文本，机制未实现）。
